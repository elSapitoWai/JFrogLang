...
class Interpreter implements Expr.Visitor<Object>,
    ...
    Interpreter() {
        globals.define("clock", new FrogCallable() {
            @Override
    ...
    public Object visitCallExpr(Expr.Call expr) {
        ...
        if (!(callee instanceof FrogCallable)) {
            throw new RuntimeError(expr.paren,
                    "Can only call functions and classes.");
        }

        FrogCallable function = (FrogCallable)callee;
    ...
    public Object visitGetExpr(Expr.Get expr) {
        ...
        if (object instanceof FrogInstance) {
            return ((FrogInstance) object).get(expr.name);
        }
    ...
    public Object visitSetExpr(Expr.Set expr) {
        ...
        Object value = evaluate(expr.value);
        ((FrogInstance)object).set(expr.name, value);
        return value;
    }
    ...
    public Object visitSuperExpr(Expr.Super expr) {
        ...
        FrogClass superclass = (FrogClass)environment.getAt(
                distance, "super");

        FrogInstance object = (FrogInstance)environment.getAt(
                distance - 1, "this");

        FrogFunction method = superclass.findMethod(expr.method.lexeme);
    ...
    /*
    Executes the statements of a block

    statements: the list of statements in the block
    environment: the environment in which the block variables will be saved
     */
    ...
    /*
    Stores the resolution information

    expr: the resolution
    depth: where to put it
     */
    ...
    /*
    Looks for a variable in local and globals and returns the nearest one
     */
